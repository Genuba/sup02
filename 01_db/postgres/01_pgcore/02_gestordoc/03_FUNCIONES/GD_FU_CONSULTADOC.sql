...
DECLARE
    reg RECORD;
BEGIN
	FOR REG IN SELECT doc_doc, doc_asunto, doc_user, doc_review, doc_sender, doc_send, doc_code, doc_cons, doc_rec, doc_rute, doc_type, doc_cod FROM ab_web_gd.gd_tdoc
	WHERE doc_doc = i
	LOOP
    RETURN NEXT reg;
    END LOOP;
